...
public class WorkEGui extends ServiceGui implements ActionListener {
  ...
  public WorkEGui(final String boundServiceName, final SwingGui myService) {
  ...
  public void onState(final WorkE worke) {
    /*
